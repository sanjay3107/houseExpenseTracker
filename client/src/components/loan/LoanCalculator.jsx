...
const LoanCalculator = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const monthlyPaymentResponse = await axios.post(API_ENDPOINTS.LOAN.CALCULATE, {
      ...
      const amortizationResponse = await axios.post(API_ENDPOINTS.LOAN.CALCULATE, {
        loanAmount: parseFloat(loanDetails.loanAmount),
        interestRate: parseFloat(loanDetails.interestRate),
        loanTerm: parseFloat(loanDetails.loanTerm),
      });
  ...
  return (
    <div className="loan-calculator-container">
      <div className="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
        <h1 className="mb-0">
          <i className="bi bi-calculator-fill text-primary me-2"></i>Loan Calculator
        </h1>
      </div>
              ...
              <>
                      ...
                      <Col md={4} className="text-center">
                        <div className="p-3 rounded-3 bg-white shadow-sm h-100">
                          ...
                          <h3 className="display-6 fw-bold text-primary mb-1">
                            {formatIndianCurrency(results.monthlyPayment)}
                          </h3>
                    ...
                    <div className="p-3 bg-light rounded">
                      ...
                      <div className="d-flex align-items-baseline">
                        <h4 className="display-6 fw-bold text-warning mb-1">
                          {(
                            (results.totalInterest / parseFloat(loanDetails.loanAmount)) *
                            100
                          ).toFixed(2)}
                          %
                        </h4>
                ...
                <Card className="mb-4 shadow-sm border-0">
                  <Card.Header className="bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                    <h5 className="mb-0 fw-bold">
                      <i className="bi bi-bar-chart-fill text-primary me-2"></i>Payment Distribution
                    </h5>
                  </Card.Header>
                  <Card.Body className="p-4">
                ...
                <Card className="shadow-sm border-0">
                  <Card.Header className="bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                    <h5 className="mb-0 fw-bold">
                      <i className="bi bi-table text-primary me-2"></i>Amortization Schedule
                    </h5>
                  </Card.Header>
                  <Card.Body className="p-4">
                      ...
                      <div className="d-flex justify-content-between align-items-center mt-3">
                        <div>
                          <small className="text-muted">
                            ...
                            {Math.min(currentPage * paymentsPerPage, amortizationSchedule.length)}{' '}
                            of {amortizationSchedule.length}
                          </small>
                        </div>
                          ...
                          {Array.from(
                            {
                              length: Math.min(
                                5,
                                Math.ceil(amortizationSchedule.length / paymentsPerPage)
                              ),
                            },
                            (_, i) => {
