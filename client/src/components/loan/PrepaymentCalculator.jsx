...
const PrepaymentCalculator = () => {
    ...
    const fetchHouseDetails = async () => {
      try {
        ...
        if (response.data && response.data.loan_details) {
          ...
          if (
            response.data.loan_details.loan_amount &&
  ...
  const handleYearClick = year => {
    ...
    if (results && results.regularLoan && results.withPrepayment) {
      ...
      const prepaymentRemainingPrincipal = getRemainingPrincipal(
        results.withPrepayment.schedule,
        year
      );
                ...
                <Table bordered size="sm" className="mt-3">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-success fw-bold">
                        {formatIndianCurrency(
                          results.regularLoan.totalPayment - results.withPrepayment.totalPayment
                        )}{' '}
                        saved
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="text-success fw-bold">
                        {formatIndianCurrency(
                          results.regularLoan.totalInterest - results.withPrepayment.totalInterest
                        )}{' '}
                        saved
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="text-success fw-bold">
                        {Math.floor(results.withPrepayment.timeShortened / 12)} years,{' '}
                        {results.withPrepayment.timeShortened % 12} months saved
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="fw-bold">
                        {formatIndianCurrency(
                          results.withPrepayment.totalPrepayments ||
                            getPrepaymentsMade(
                              results.withPrepayment.schedule,
                              Math.ceil(results.withPrepayment.termMonths / 12)
                            )
                        )}
                      </td>
                      <td>-</td>
            ...
            <>
              <Card className="mb-4 shadow-sm border-0">
                <Card.Header className="bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                  <h5 className="mb-0 fw-bold">
                    <i className="bi bi-graph-down-arrow text-primary me-2"></i>Loan Timeline
                    Visualization
                  </h5>
                </Card.Header>
                <Card.Body className="p-4">
                  {results && results.regularLoan && results.withPrepayment ? (
                    <div>
                      ...
                      <div className="timeline-container mb-4">
                        <div
                          className="timeline-track position-relative"
                          style={{ height: '100px', padding: '20px 0' }}
                        >
                          {/* Timeline base line */}
                          <div
                            style={{
                          ...
                          >
                            {Array.from({
                              length: Math.ceil(results.regularLoan.termMonths / 12) + 1,
                            }).map((_, index) => {
                              const year = index;
                              const isSelected = selectedYear === year;
                              const regularPrincipal = getRemainingPrincipal(
                                results.regularLoan.schedule,
                                year
                              );
                              const prepaymentPrincipal = getRemainingPrincipal(
                                results.withPrepayment.schedule,
                                year
                              );
                          ...
                          <Row className="g-3">
                            <Col md={6}>
                              <div className="card border-danger h-100">
                                <div className="card-header bg-danger text-white py-2 fw-bold">
                                  Regular Loan
                                </div>
                                <div className="card-body p-3">
                                  <div className="mb-2">
                                    ...
                                    <h5 className="mb-0">
                                      {formatIndianCurrency(yearDetails.regular.remainingPrincipal)}
                                    </h5>
                                  </div>
                                  <div className="mb-2">
                                    <small className="text-muted d-block">
                                    ...
                                    <h5 className="mb-0">
                                      {formatIndianCurrency(yearDetails.regular.interestPaid)}
                                    </h5>
                                  </div>
                                  <ProgressBar
                                    variant="danger"
                                    now={
                                      (yearDetails.regular.interestPaid /
                                        results.regularLoan.totalInterest) *
                                      100
                                    }
                              ...
                              <div className="card border-success h-100">
                                ...
                                <div className="card-body p-3">
                                  <div className="mb-2">
                                    ...
                                    <h5 className="mb-0">
                                      {formatIndianCurrency(
                                        yearDetails.withPrepayment.remainingPrincipal
                                      )}
                                    </h5>
                                  </div>
                                  <div className="mb-2">
                                    ...
                                    <h5 className="mb-0">
                                      {formatIndianCurrency(
                                        yearDetails.withPrepayment.interestPaid
                                      )}
                                    </h5>
                                  </div>
                                  <div className="mb-2">
                                    ...
                                    <h5 className="mb-0">
                                      {formatIndianCurrency(
                                        yearDetails.withPrepayment.prepaymentsMade
                                      )}
                                    </h5>
                                  </div>
                                  <ProgressBar
                                    ...
                                    now={
                                      (yearDetails.withPrepayment.interestPaid /
                                        results.withPrepayment.totalInterest) *
                                      100
                                    }
                          ...
                          <div className="mt-3 p-3 bg-white rounded border">
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-2">
                              ...
                              <div>
                                ...
                                <span className="text-success ms-2">
                                  {formatIndianCurrency(
                                    yearDetails.regular.remainingPrincipal -
                                      yearDetails.withPrepayment.remainingPrincipal
                                  )}
                                </span>
                              </div>
