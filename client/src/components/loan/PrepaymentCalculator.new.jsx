                      ...
                      <div>
                        ...
                        <div className="loan-comparison mb-4">
                          ...
                          <div>
                            ...
                            <ProgressBar 
                              variant="success" 
                              now={(results.withPrepayment.termMonths / results.regularLoan.termMonths) * 100} 
                              style={{ height: '20px' }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="text-center">
                          <div className="mb-4">
                            ...
                            <h3 className="text-success">{formatIndianCurrency(results.withPrepayment.interestSaved)}</h3>
                          </div>
                          
                          <div className="mb-4">
                            <h5 className="text-muted mb-2">Time Saved</h5>
                            <h3>{Math.floor(results.withPrepayment.timeShortened / 12)} years {results.withPrepayment.timeShortened % 12} months</h3>
                          </div>
                        </div>
                      </div>
                    ) : (
