...
export const loanService = {
  ...
  calculateAmortizationSchedule: (loanData) => api.post('/loan-calculator/amortization-schedule', loanData),
  
  // Calculate prepayment impact
  calculatePrepaymentImpact: (prepaymentData) => api.post('/loan-calculator/prepayment-impact', prepaymentData)
};
